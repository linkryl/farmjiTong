...
Prop_system::Prop_system()
{
	...
	//0收获结构体的第二项为空 
	//2最大掉落2 
	Harvest stone_harvest(3020, 0, 2, 0);
	Harvest tree_harvest(3021, 0, 3, 0);
	Harvest ironstone_harvest(3022, 0, 1, 0);
	Harvest seaweed_harvest(3120, 0, 1, 0);
	Harvest carp_harvest(3121, 0, 1, 0);
	Harvest sturgeon_harvest(3122, 0, 1, 0);
	Harvest catfish_harvest(3123, 0, 1, 0);
	Harvest super_cucumber_harvest(3124, 0, 1, 0);
	Harvest pufferfish_harvest(3125, 0, 1, 0);
	Harvest legend_harvest(3126, 0, 1, 0);
	...
	Harvest_map.insert(std::make_pair(3011, tree_harvest));//3011是树
	Harvest_map.insert(std::make_pair(3012, ironstone_harvest));//3012是铁矿石 
	Harvest_map.insert(std::make_pair(3120, seaweed_harvest));//3120是海草
	Harvest_map.insert(std::make_pair(3121, carp_harvest));//3121是鲤鱼
	Harvest_map.insert(std::make_pair(3122, sturgeon_harvest));//3122是鲟鱼
	Harvest_map.insert(std::make_pair(3123, catfish_harvest));//3123是鲶鱼
	Harvest_map.insert(std::make_pair(3124, super_cucumber_harvest));//3121是大海参
	Harvest_map.insert(std::make_pair(3125, pufferfish_harvest));//3122是河豚 
	Harvest_map.insert(std::make_pair(3126, legend_harvest));//3122是传说之鱼 
}
